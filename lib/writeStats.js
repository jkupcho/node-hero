...
writeBitsFromString(statsBinary, newCharacter, offset);
...
let delimiterBinary = padRight(0x1ff.toString(2), 16);

writeBitsFromString(delimiterBinary, itemBufferItems, 3);
