...
exports.writeBitsFromString = function(bitString, buffer, offset) {
  if (bitString.length % 8 !== 0) { throw Error('bitString must be a multiple of 8, prepend or append 0s, first.'); }
...
exports.padLeft = function(padStr, length, str) {
  return Array(length - padStr.length + 1).join(str || '0') + padStr;
}

exports.padRight = function(padStr, length, str) {
